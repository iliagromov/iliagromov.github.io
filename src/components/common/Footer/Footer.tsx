        ...
        <footer className="footer">
			<div className="wrapper">
				<div className="footer-content">
					...
					<div className="footer-content__item">
						<div className="page__subtitle page_padding-bottom-25">почта</div><a className="page__subtitle page__link page_bold" href="mailto:studio.gromov.inc@yandex.ru">studio.gromov.inc@yandex.ru</a>
					</div>
					<div className="footer-content__item">
						<div className="page__subtitle page_padding-bottom-25">социальные сети</div>
						<div className="social">
                            
                            <a className="social__item-link social__item-icon" href="https://vk.com/igromov.digital" target="_blank">
                                <StaticImage className="page__img" src={'../../../assets/images/social/icon-social-vk.svg'} alt="social" title="social"/>
                            </a>
                            ...
                            <a className="social__item-link social__item-icon" href="https://t.me/igromov_digital" target="_blank">
                                <StaticImage className="page__img" src={'../../../assets/images/social/icon-social-telegram.svg'} alt="social" title="social"/>
                            </a>
						</div>
					</div>
				</div>
